  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-black overflow-hidden flex flex-col font-mono">
      ...
      <div className="relative z-10 flex flex-col h-full p-5 pb-24">
        ...
        {/* Размещаем над списком товаров, справа. Выглядит как статусная панель */}
        <div className="flex justify-end mb-4 px-1">
          <div className="bg-[#111] border-2 border-[#daa520]/40 px-4 py-2 flex items-center gap-3 shadow-[4px_4px_0_#000]">
            <div className="flex flex-col items-end">
              <span className="text-[#daa520]/50 text-[7px] uppercase tracking-widest leading-none mb-1">Твой баланс</span>
              <span className="text-[#daa520] text-sm font-black tracking-tighter leading-none">{gold} G</span>
            </div>
            <div className="w-4 h-4 bg-[#daa520] shadow-[2px_2px_0_#000]" />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar">
          {items.map(item => (
            ...
            >
              <div className="w-14 h-14 bg-[#111] border border-[#daa520]/40 flex items-center justify-center text-2xl shrink-0 shadow-[inset_0_0_10px_rgba(0,0,0,0.8)]">
                <span className="drop-shadow-[0_2px_2px_rgba(0,0,0,1)]">{item.icon}</span>
              </div>
              
              <div className="flex-1 min-w-0">
                <h3 className="text-[#daa520] font-black text-[12px] uppercase mb-1 truncate">
                  {item.name}
                </h3>
